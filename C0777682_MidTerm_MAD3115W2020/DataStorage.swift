...
class DataStorage
{
    ...
    func loadCustomerDetails()
    {
        ...
        let i1 = Internet(billId: "I001", billDate: "20/02/2019", billType: .Internet , internetProvider: "Rogers", internetGBUsed: "10")
        
        let i2 = Internet(billId: "I002", billDate: "14/03/2019", billType: .Internet , internetProvider: "Freedom", internetGBUsed: "5")
        let h1 = Hydro(billId: "H001", billDate: "26/04/2018", billType: .Hydro, agencyName: "Planet Energy", unitConsumed: "200")
        let h2 = Hydro(billId: "H002", billDate: "03/09/2019", billType: .Hydro, agencyName: "OntarioHydro", unitConsumed: "700")
        let m1 = Mobile(billId: "M001", billDate: "07/09/2019", billType: .Mobile, manufacturerName: "Apple Inc.", mobilePlan: "4.5GB + 1000 Min", mobileNumber: "4504500577", internetGBUsed: "4", minuteUsed: "100")
