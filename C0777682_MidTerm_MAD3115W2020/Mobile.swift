...
class Mobile : Bill{
  ...
  var minuteUsed : String
    init(billId: String, billDate: String,billType : BillType,totalBill : String, manufacturerName : String, mobilePlan : String, mobileNumber : String, internetGBUsed : String, minuteUsed : String) {
